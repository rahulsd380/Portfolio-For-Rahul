...
const Projects = () => {
  ...
  const personalProjects = data?.data?.filter(project => project.projectType === "Personal");
  const companyProjects = data?.data?.filter(project => project.projectType === "Company");
